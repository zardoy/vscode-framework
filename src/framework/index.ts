...
export class VscodeFramework {
    ...
    public registerCommand(command: Commands['regular'][number]['id'], callback: () => MaybePromise<void>) {
        this.ctx.subscriptions.push(
            vscode.commands.registerCommand(`${this.extensionIDName}.${command}`, callback),
        );
    }
